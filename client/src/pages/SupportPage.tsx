          ...
          <div className="bg-black/30 border border-slate-700 p-6 space-y-3">
            <div className="flex items-start gap-3">
              ...
              <p className="text-slate-300 text-sm flex-1">
                ...
                attack or less. Build a deck with higher attack monsters to gain
                an advantage.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <div className="text-blue-400 font-mono">▸</div>
              <p className="text-slate-300 text-sm flex-1">
                <strong>Battle phase:</strong> Monsters summoned this turn can't
                attack. Wait one turn before attacking with newly summoned
                monsters.
              </p>
            </div>
            <div className="flex items-start gap-3">
