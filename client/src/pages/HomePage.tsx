...
const HomePage = () => {
  ...
  return (
    <div {...getXRProps()} className="min-h-screen relative overflow-hidden">
      ...
      {/* Hero Section */}
      <main {...getXRProps()} className="relative max-w-7xl mx-auto px-6 lg:px-8">
        {/* Hero Content */}
        <div {...getXRProps()} className="text-center py-16 sm:py-20">
          <h1 {...getXRProps()} className="text-4xl sm:text-6xl lg:text-7xl font-bold mb-8 bg-gradient-to-r from-red-500 via-purple-500 to-blue-500 bg-clip-text text-transparent leading-tight">
            THE ULTIMATE<br />
            YU-GI-OH! EXPERIENCE
          </h1>
          <p {...getXRProps()} className="text-xl sm:text-2xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          {/* Demo Placeholder */}
          <div {...getXRProps()} className="bg-slate-800/80 backdrop-blur-xl rounded-2xl border border-slate-600/50 shadow-2xl p-8 mb-12 ring-1 ring-slate-700/30 max-w-4xl mx-auto">
            <h2 {...getXRProps()} className="text-2xl font-bold text-slate-100 mb-6 tracking-wider">
              🎮 PLAYABLE DEMO
            </h2>
            <div {...getXRProps()} className="aspect-video bg-slate-700/50 rounded-xl border-2 border-slate-600 flex items-center justify-center">
              <div {...getXRProps()} className="text-center">
                <div {...getXRProps()} className="text-6xl mb-4">⚡</div>
                <p {...getXRProps()} className="text-slate-300 text-lg font-medium">
          ...
          {/* Action Buttons */}
          <div {...getXRProps()} className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            {isAuthenticated ? (
              <>
                <Link
                  to="/cardshop"
        ...
        {/* Features Section */}
        <div {...getXRProps()} className="py-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div {...getXRProps()} className="bg-slate-800/80 backdrop-blur-xl rounded-2xl border border-slate-600/50 shadow-2xl p-6 ring-1 ring-slate-700/30 text-center">
            <div {...getXRProps()} className="text-4xl mb-4">🏪</div>
            <h3 {...getXRProps()} className="text-xl font-bold text-slate-100 mb-3 tracking-wider">
              CARD SHOP
            </h3>
      ...
      {/* Footer */}
      <footer {...getXRProps()} className="relative bg-slate-800/90 backdrop-blur-lg border-t border-slate-700/50 shadow-2xl mt-16">
