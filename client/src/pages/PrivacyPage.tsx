  ...
  return (
    <div className="border border-slate-700 p-8 max-w-4xl">
      <div className="space-y-8">
          ...
          <div className="bg-black/30 border border-slate-700 p-6 space-y-4">
            ...
            <ul className="space-y-2 text-slate-300 text-sm">
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-400">•</span>
                <span>
                  Your data never leaves your device and is never accessible to
                  us
                </span>
              </li>
            </ul>
        ...
        {/* External Links */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold tracking-wider">EXTERNAL LINKS</h2>
          <p className="text-slate-300 text-sm leading-relaxed">
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            ...
            this policy. Since we don't collect contact information, we cannot
